      ...
      <div className="relative max-w-5xl mx-auto z-10">
        ...
        <div className="text-center mb-10 sm:mb-12">
          <div className="flex justify-center mb-4">
            <span className="text-teal-600 text-xs font-bold tracking-[0.25em] uppercase bg-teal-50/50 px-4 py-1.5 rounded-full border border-teal-200/50 shadow-sm flex items-center gap-1.5 animate-pulse">
              <Instagram className="w-3.5 h-3.5 text-teal-500" /> Instagram Feed
            </span>
          </div>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-['Georgia'] font-bold text-slate-900 tracking-tight mb-4">
            Global Architecture <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-blue-600">Showcase</span>
          </h2>
              ...
              <div className="flex-1 text-left space-y-3 sm:space-y-4">
                ...
                <div className="space-y-1 text-slate-700 text-xs sm:text-sm font-light leading-relaxed">
                  ...
                  <p className="flex items-center justify-start gap-1">
                    <span className="text-slate-800">👤</span> Founder: <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-blue-600 font-bold hover:underline cursor-pointer">@_charaan01</span>
                  </p>
                  <p className="flex items-center justify-start gap-1">
                    <span className="text-teal-500">🛡️</span> Verified Google Developer
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mt-12 sm:mt-16 mb-16 sm:mb-20">
          <div className="flex items-center gap-2 mb-6 sm:mb-8 justify-center lg:justify-start">
            <span className="w-1.5 h-6 bg-gradient-to-b from-teal-400 to-blue-500 rounded-full shrink-0" />
          ...
          <div className="relative bg-white border border-blue-100/40 rounded-[2.5rem] p-8 sm:p-10 md:p-12 shadow-[0_20px_60px_-15px_rgba(0,100,255,0.08)] flex flex-col md:flex-row items-center gap-8 md:gap-14 overflow-hidden group/special">
            ...
            <div className="flex-1 space-y-7 relative z-10">
              <h4 className="text-3xl sm:text-4xl lg:text-[42px] font-['Georgia'] font-extrabold tracking-tight leading-[1.15]">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-slate-900 via-teal-900 to-slate-900">
              ...
              <div className="md:hidden w-full max-w-[320px] mx-auto aspect-[9/16] shrink-0 rounded-[2rem] shadow-[0_15px_40px_rgba(0,0,0,0.12)] border border-slate-200/80 bg-slate-900 relative group transition-all duration-500 p-1 will-change-transform">
                <div className="w-full h-full relative overflow-hidden rounded-[1.8rem]">
                  <iframe
                    src="https://www.youtube.com/embed/0moOyDn_Emk?modestbranding=1&rel=0&iv_load_policy=3"
              ...
              <p className="text-slate-600 font-light text-base sm:text-lg leading-relaxed">
                ...
                <strong className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-blue-600 block mt-3 text-lg">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
                {[
                  ...
                  <li key={idx} className="flex items-center gap-3 text-sm sm:text-base text-slate-700 font-medium group cursor-default">
                    <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-teal-50 to-blue-50 border border-teal-100/50 flex items-center justify-center shrink-0 group-hover:scale-110 group-hover:shadow-[0_4px_12px_rgba(20,184,166,0.15)] group-hover:border-teal-200 transition-all duration-300">
                      <Zap className="w-4 h-4 fill-teal-500 text-teal-500 group-hover:fill-blue-500 group-hover:text-blue-500 transition-colors duration-300" />
                    </div>
                    <span className="group-hover:text-teal-600 transition-colors duration-300">{item}</span>
                  </li>
                ))}
              </ul>
              ...
              <div className="pt-6 border-t border-slate-100 flex flex-wrap gap-4 items-center">
                <button
                  ...
                  className="group relative flex items-center justify-center w-max uppercase tracking-wider overflow-hidden rounded-full bg-white dark:bg-slate-900 border-2 border-teal-500 text-teal-600 dark:border-teal-400 dark:text-teal-400 hover:border-transparent dark:hover:border-transparent px-8 h-12 sm:h-14 text-sm sm:text-base font-bold shadow-sm transition-all duration-300 hover:scale-[1.02] hover:shadow-lg"
                >
