...
const WhatsAppButton = () => {
    ...
    useEffect(() => {
        // Delay showing to match the chatbot animation if any
    ...
    return (
        <div className="fixed bottom-6 left-6 z-[9999] animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            >
                ...
                <span className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-20" style={{ animationDuration: '2s' }}></span>
                ...
                {/* Tooltip on hover */}
                <span className="absolute left-[70px] px-4 py-2.5 bg-slate-900 dark:bg-white text-white dark:text-slate-900 text-sm font-semibold rounded-xl opacity-0 group-hover:opacity-100 -translate-x-4 group-hover:translate-x-0 transition-all duration-300 pointer-events-none whitespace-nowrap shadow-xl">
                    Chat with us
                </span>
            </a>
        </div>
